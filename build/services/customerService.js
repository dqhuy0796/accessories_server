...
var handleGetCustomer = function handleGetCustomer(customerId) {
  return new Promise( /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
      var data, customers, customer;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 5:
              ...
              data.code = _constant.ResponseCode.SUCCESS;
            ...
            case 12:
              ...
              if (customer) {
                ...
                data.code = _constant.ResponseCode.DATABASE_ERROR;
...
var handleCreateCustomer = function handleCreateCustomer(customer) {
  return new Promise( /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
      var isExist, _code, _message, hashedPassword, code, message;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 3:
              ...
              if (isExist) {
                _code = _constant.ResponseCode.DATABASE_ERROR;
                _message = "Phone number already in use.";
                resolve({
                  code: _code,
                  message: _message
                });
...
var handleUpdateCustomer = function handleUpdateCustomer(customer) {
  return new Promise( /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(resolve, reject) {
      var data, targetCustomer;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 8:
              ...
              break;
            case 12:
              data.code = _constant.ResponseCode.FILE_NOT_FOUND;
...
var handleUpdateCustomerAddress = function handleUpdateCustomerAddress(phoneNumber, address) {
  return new Promise( /*#__PURE__*/function () {
...
var handleDeleteCustomer = function handleDeleteCustomer(customerId) {
  return new Promise( /*#__PURE__*/function () {
          ...
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              return _models["default"].Product.findAll({
                where: {
                  name: _defineProperty({}, Op.like, "%".concat(input, "%"))
                },
