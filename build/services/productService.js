      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _models["default"].Material.findAll();
          case 3:
...
var handleCountProducts = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var _yield$Promise$all, _yield$Promise$all2, count_by_category, count_by_material, count_by_color;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return Promise.all([_models["default"].CountProductByCategoryView.findAll(), _models["default"].CountProductByMaterialView.findAll(), _models["default"].CountProductByColorView.findAll()]);
          case 3:
            _yield$Promise$all = _context3.sent;
            _yield$Promise$all2 = _slicedToArray(_yield$Promise$all, 3);
            count_by_category = _yield$Promise$all2[0];
            count_by_material = _yield$Promise$all2[1];
            count_by_color = _yield$Promise$all2[2];
            return _context3.abrupt("return", {
              code: _constant.ResponseCode.SUCCESS,
              message: "get products count by category successfully",
              result: [{
                count_by: "category",
                data: count_by_category !== null && count_by_category !== void 0 ? count_by_category : []
              }, {
                count_by: "material",
                data: count_by_material !== null && count_by_material !== void 0 ? count_by_material : []
              }, {
                count_by: "color",
                data: count_by_color !== null && count_by_color !== void 0 ? count_by_color : []
              }]
            });
          case 11:
            _context3.prev = 11;
        ...
        switch (_context5.prev = _context5.next) {
          ...
          case 7:
            ...
            return _context5.abrupt("return", {
              ...
              result: _objectSpread(_objectSpread({}, product), {}, {
                images: images
              })
            });
          case 9:
...
var handleSearchProducts = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(keyword, page) {
    var currentPage, _yield$db$Product$fin3, count, rows;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            return _models["default"].Product.findAndCountAll({
              where: _defineProperty({}, Op.or, [{
                ...
                slug: _defineProperty({}, Op.like, "%".concat(keyword, "%"))
              }, {
                description: _defineProperty({}, Op.like, "%".concat(keyword, "%"))
              }]),
              order: [["id", "DESC"]],
              limit: 12,
              offset: (currentPage - 1) * 12
          ...
          case 5:
            _yield$db$Product$fin3 = _context6.sent;
  ...
  return function handleSearchProducts(_x4, _x5) {
...
var handleCreateProduct = /*#__PURE__*/function () {
  ...
  return function handleCreateProduct(_x6) {
...
var handleUpdateProduct = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(product) {
    var t, existed, lastVersionImages, removedImages, uploadedImages;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 11:
            lastVersionImages = _context8.sent;
            removedImages = getDifference(product.images, lastVersionImages);
            uploadedImages = getDifference(lastVersionImages, product.images);
            _context8.next = 16;
            return Promise.all([removedImages.length > 0 && _models["default"].Image.destroy({
              ...
              transaction: t
            }), !_lodash["default"].isEqual(product, existed) && _models["default"].Product.update(_objectSpread({}, product), {
              where: {
                id: product.id
              },
              transaction: t
  ...
  return function handleUpdateProduct(_x7) {
    return _ref8.apply(this, arguments);
  };
}();
var handleDeleteProduct = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(product) {
  ...
  return function handleDeleteProduct(_x8) {
