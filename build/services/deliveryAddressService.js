...
var handleGetDeliveryAddress = function handleGetDeliveryAddress(customerId) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return _models["default"].DeliveryAddress.findAll({
                where: {
...
var handleCreateDeliveryAddress = function handleCreateDeliveryAddress(address) {
  return new Promise( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              existedAddresses = _context2.sent;
              // if nothing change -> invalid
              existedAddresses.forEach(function (existedAddress) {
                if (existedAddress.details == address.details && existedAddress.ward == address.ward && existedAddress.district == address.district && existedAddress.province == address.province) {
                  resolve({
              ...
              _context2.next = 8;
              return _models["default"].DeliveryAddress.update({
                isDefault: false
              }, {
                where: {
                  customerId: address.customerId
            ...
            case 8:
              _context2.next = 10;
              return _models["default"].DeliveryAddress.create({
                customerId: address.customerId,
...
var handleUpdateDeliveryAddress = function handleUpdateDeliveryAddress(newAddress) {
  return new Promise( /*#__PURE__*/function () {
...
var handleDeleteDeliveryAddress = function handleDeleteDeliveryAddress(addressId, customerId) {
  return new Promise( /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 4;
              return _models["default"].DeliveryAddress.destroy({
                where: {
                  customerId: customerId
                }
              });
...
module.exports = {
  handleGetDeliveryAddress: handleGetDeliveryAddress,
  handleCreateDeliveryAddress: handleCreateDeliveryAddress,
