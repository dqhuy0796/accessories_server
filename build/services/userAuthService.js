...
var handleLogin = function handleLogin(username, password) {
  return new Promise( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      var user, _code, _message, isValidPassword, _code2, _message2, result, accessToken, refreshToken, code, message;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              user = _context.sent;
              if (!user) {
                _code = _constant.ResponseCode.AUTHENTICATION_ERROR;
              ...
              if (!isValidPassword) {
                _code2 = _constant.ResponseCode.AUTHENTICATION_ERROR;
                _message2 = "Incorrect username or password";
                resolve({
                  code: _code2,
                  message: _message2
                });
              ...
              _context.next = 12;
              return handleGenerateRefreshToken(user.username, user.role);
            case 12:
...
var handleGenerateRefreshToken = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(username, role) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 13:
            return _context3.abrupt("return", newRefreshToken);
          case 16:
            _context3.prev = 16;
  ...
  return function handleGenerateRefreshToken(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var handleRegenerateAccessToken = /*#__PURE__*/function () {
              ...
              try {
                _jsonwebtoken["default"].verify(refreshToken, process.env.NODE_REFRESH_TOKEN_SECRET_KEY, /*#__PURE__*/function () {
                  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(err, data) {
                    var existedRefreshToken, accessToken;
  ...
  return function handleRegenerateAccessToken(_x7) {
...
var isExistUsername = function isExistUsername(currentUsername) {
  return new Promise( /*#__PURE__*/function () {
...
module.exports = {
  ...
  handleRegenerateAccessToken: handleRegenerateAccessToken
};