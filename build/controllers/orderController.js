...
var getOrder = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var customerId, orderUuid, data, _data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            customerId = req.query.customerId;
            orderUuid = req.query.orderUuid;
            if (!(customerId && !orderUuid)) {
              _context.next = 7;
              break;
            }
            _context.next = 5;
            return _orderService["default"].handleGetOrders(customerId);
          case 5:
            data = _context.sent;
          ...
          case 7:
            ...
            _context.next = 10;
            return _orderService["default"].handleGetOrderById(orderUuid);
          case 10:
            _data = _context.sent;
...
var createOrder = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var customerId, deliveryAddressId, items, paymentDetails, data;
...
var confirmOrder = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 3;
            return _orderService["default"].handleConfirmOrder(req.body.uuid);
          case 3:
            data = _context3.sent;
  ...
  return function confirmOrder(_x5, _x6) {
...
var deliveryOrder = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 3;
            return _orderService["default"].handleDeliveryOrder(req.body.uuid);
          case 3:
            data = _context4.sent;
  ...
  return function deliveryOrder(_x7, _x8) {
...
var finishedOrder = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 3;
            return _orderService["default"].handleFinishedOrder(req.body.uuid);
          case 3:
            data = _context5.sent;
  ...
  return function finishedOrder(_x9, _x10) {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.next = 3;
            return _orderService["default"].handleCancelOrder(req.body.uuid);
          case 3:
            data = _context6.sent;
...
var deleteOrder = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            _context7.next = 3;
            return _orderService["default"].handleDeleteOrder(req.body.id);
          case 3:
            data = _context7.sent;
            console.log(data);
  ...
  return function deleteOrder(_x13, _x14) {
