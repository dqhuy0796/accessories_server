...
var getCart = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            customerId = req.query["customer-id"] || req.query["customerId"];
            if (customerId) {
              _context.next = 3;
              break;
            }
          ...
          case 3:
            _context.next = 5;
            return _cartService["default"].handleGetCart(customerId);
          case 5:
            data = _context.sent;
  ...
  return function getCart(_x, _x2) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            _context2.next = 8;
            return _cartService["default"].handleUpdateDeliveryAddress(item);
          case 8:
            data = _context2.sent;
