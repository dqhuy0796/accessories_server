...
var getCustomer = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return _customerService["default"].handleGetCustomer(req.query.id);
          case 3:
            data = _context.sent;
  ...
  return function getCustomer(_x, _x2) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 10;
            return _customerService["default"].handleCreateCustomer(user);
          case 10:
            data = _context2.sent;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            user.address = req.body.address;
            _context3.next = 10;
            return _customerService["default"].handleUpdateCustomer(user);
          case 10:
            data = _context3.sent;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 3;
            return _customerService["default"].handleUpdateCustomerAddress(req.body.phoneNumber, req.body.address);
          case 3:
            data = _context4.sent;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 3;
            return _customerService["default"].handleDeleteCustomer(req.body.id);
          case 3:
            data = _context5.sent;
            console.log(data);
